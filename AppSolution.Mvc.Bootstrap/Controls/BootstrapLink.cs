...
namespace AppSolution.Mvc.Bootstrap.Controls
{
    public class BootstrapLink : IHtmlString
    {
        ...
        public BootstrapLink IconPrepend(string icon)
        {
            this._iconPrepend = icon;
            return this;
        }

        public BootstrapLink IconPrepend(string icon, bool isWhite)
        {
            this._iconPrepend = icon;
        ...
        public BootstrapLink IconAppend(string icon)
        {
            this._iconAppend = icon;
            return this;
        }

        public BootstrapLink IconAppend(string icon, bool isWhite)
        {
            this._iconAppend = icon;

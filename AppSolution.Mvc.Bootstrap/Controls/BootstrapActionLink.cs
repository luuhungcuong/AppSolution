...
namespace AppSolution.Mvc.Bootstrap.Controls
{
    public class BootstrapActionLink : IHtmlString
    {
        ...
        private string _iconPrepend;
        private string _iconAppend;
        ...
        public BootstrapActionLink IconPrepend(string icon)
        {
            this._iconPrepend = icon;
            return this;
        }

        public BootstrapActionLink IconPrepend(string icon, bool isWhite)
        {
            this._iconPrepend = icon;
        ...
        public BootstrapActionLink IconAppend(string icon)
        {
            this._iconAppend = icon;
            return this;
        }

        public BootstrapActionLink IconAppend(string icon, bool isWhite)
        {
            this._iconAppend = icon;
        ...
        public string ToHtmlString()
        {
            ...
            {
                if (_iconPrepend != string.Empty) iPrependString = new BootstrapIcon(_iconPrepend, _iconPrependIsWhite).ToHtmlString() + " ";
                if (_iconAppend != string.Empty) iAppendString = " " + new BootstrapIcon(_iconAppend, _iconAppendIsWhite).ToHtmlString();

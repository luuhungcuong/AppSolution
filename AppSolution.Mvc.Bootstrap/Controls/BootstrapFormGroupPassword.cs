...
{
    public class BootstrapFormGroupPassword : BootstrapTextBoxBase<BootstrapFormGroupPassword>
    {
        public BootstrapFormGroupPassword(HtmlHelper html, string htmlFieldName, ModelMetadata metadata)
        ...
        {
            return Renderer.RenderFormGroupPassword(html, _model, null);
        }

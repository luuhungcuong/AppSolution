...
{
    public class BootstrapFormGroupRadioButtonTrueFalse : BootstrapRadioButtonTrueFalse
    {
        public BootstrapFormGroupRadioButtonTrueFalse(HtmlHelper html, string htmlFieldName, ModelMetadata metadata)
        ...
        {
            return Renderer.RenderFormGroupRadioButtonTrueFalse(html, _model, null);
        }
